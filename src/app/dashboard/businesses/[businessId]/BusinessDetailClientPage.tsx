  ...
  useEffect(() => {
    ...
    return (
      <div className="flex-1 p-6">
        <h1 className="text-3xl font-bold text-gray-900">Edit Business Profile: {business.businessName}</h1>
        <form action={formAction} className="mt-8 max-w-2xl p-6 bg-white shadow-md rounded-lg">
          ...
          <div className="mb-6 flex flex-col items-center">
            ...
            <label htmlFor="logo" className="mt-4 block text-sm font-medium text-gray-700">
              Upload New Logo
            </label>
            <input
              id="logo"
          ...
          <div>
            ...
            <input
              ...
              type="number"
              step="0.01"
              defaultValue={parseFloat(business.percentOwnership)}
              required
              className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-gray-900"
            />
          </div>
          ...
          <div>
            ...
            {business.businessMaterialsUrl && (
              <p className="mt-2 text-sm text-gray-500">Current: <a href={business.businessMaterialsUrl} target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:underline">View Materials</a></p>
            )}
          </div>
